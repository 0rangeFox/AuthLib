...
public class LegacyUserAuthentication
    ...
    private static final URL AUTHENTICATION_URL = HttpAuthenticationService.constantURL((String)"https://login.minecraft.net");
    ...
    public void logIn() throws AuthenticationException {
        ...
        this.setSelectedProfile(new GameProfile(UUIDTypeAdapter.fromString((String)profileId), profileName));
